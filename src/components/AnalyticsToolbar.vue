<template>
  <div class="step-testing-panel">
    ...
    <button class="btn-utility print" @click="emit('trigger-print')">🖨️ Print</button>
...
/* 🔄 UPDATED: Registered 'trigger-print' hook inside definition macro */
const emit = defineEmits(['fetch-trends', 'fetch-blocks', 'fetch-products', 'fetch-groups', 'run-analysis', 'trigger-print'])
</script>
